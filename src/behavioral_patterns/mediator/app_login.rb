...
class AppLogin < Mediator
  ...
  def create_colleagues
    ...
    radio_button_guest = TkRadiobutton.new(
      radio_button_frame,
      "text" => "Guest",
      "variable" => @val,
      "value" => 0
    ...
    radio_button_login = TkRadiobutton.new(
      radio_button_frame,
      "text" => "Login",
      "variable" => @val,
      "value" => 1
    ...
    label_password = TkLabel.new(text_field_frame, "text" => "Password:")
    label_password.grid("row" => 1, "column" => 0)

    text_username = TkEntry.new(text_field_frame, "width" => 20)
    text_username.grid("row" => 0, "column" => 1)
    @text_username = ColleagueTextField.new(text_username)

    text_password = TkEntry.new(text_field_frame, "width" => 20, "show" => "*")
    ...
    button_ok = TkButton.new(button_frame, "text" => "OK")
    button_ok.grid("row" => 0, "column" => 0)
    @button_ok = ColleagueButton.new(button_ok)

    button_cancel = TkButton.new(button_frame, "text" => "Cancel")
